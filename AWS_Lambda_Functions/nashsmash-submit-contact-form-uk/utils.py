# ==============================================================================
# AWS_Lambda_Functions/nashsmash-submit-contact-form-uk/utils.py
# ==============================================================================
import json
import logging
...
def get_metadata_from_event(event):
    """Extract metadata from Lambda event for UK form"""
    return {
        ...
        'acceptLanguage': event.get('headers', {}).get('Accept-Language', ''),
    }
